...
namespace GymManagementSystem
{
    public partial class frmLogin : Form
    {
        ...
        {
            MetroFramework.MetroMessageBox.Show(this, "Login Completed Successfully...Press OK Button then Wait Some Moment", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
            if (UserID.Text == "")
            {
            ...
            try
            {
                ...
                if (cc.rdr.Read())
                {
                    ...
                    if ((UserType.Text == "Admin"))
                    {
                       ...
                       frm.fitnessMeasureToolStripMenuItem.Enabled = true;
